          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  I’m a tech-driven BCA student with a strong interest in web development, Android app design, and database management.
I’ve worked on multiple academic and personal projects focusing on solving real-world problems through smart technology.
