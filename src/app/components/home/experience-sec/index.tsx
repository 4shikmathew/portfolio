...
const ExperienceSec = () => {
    const experiences = [
        {
            year: "Frontend",
            title:"Creating responsive and interactive user interfaces.",
            description:"HTML, CSS, JavaScript, Bootstrap"
        },
        {
            year: "Backend",
            title:"Handling databases, logic, and server operations.",
            description:"PHP, MySQL" 
        },
        {
             year: "Tools",
            title:"Using VS Code, GitHub, and Figma for efficient development.",
            description:"VS Code, Git & GitHub, Figma"
        },
        {
             year: "Other",
